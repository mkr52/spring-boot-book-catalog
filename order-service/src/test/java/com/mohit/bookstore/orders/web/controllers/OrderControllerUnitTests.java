...
import static com.mohit.bookstore.orders.testdata.TestDataFactory.createOrderRequestWithInvalidCustomer;
...
class OrderControllerUnitTests {
    ...
    static Stream<Arguments> createOrderRequestProvider() {
        return Stream.of(arguments(named("Order with Invalid Customer", createOrderRequestWithInvalidCustomer())));
